...
namespace Metroit.CommunityToolkit.Mvvm
{
    ...
    public class TrackingObservableRecipientWithState<T> : TrackingObservableRecipient<T>, IStateObject where T : class
    {
        ...
        /// 新しいインスタンスを生成します。
        /// </summary>
        public TrackingObservableRecipientWithState() : base() { }
